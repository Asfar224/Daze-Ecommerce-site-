  ...
  return (
    <div className=''>
        ...
        <div className='flex justify-between gap-4'>
            ...
            <div className='w-1/4 h-32 relative gap-4 mt-8 hover:cursor-pointer' key={item._id} onClick={()=> setIndex(i)}>
               <Image src={item.image?.url} alt='' fill sizes='30vw' className='object-cover rounded-xl'/>
           </div>
        )}
        </div>
